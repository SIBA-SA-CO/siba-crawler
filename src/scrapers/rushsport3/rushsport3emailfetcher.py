...
class RushSport3EmailFetcher:
    def __init__(self, logger):
        self.logger = logger
        self.subject_filter = "EPG Schedule RushSports3"
        self.subject_filters = ["EPG Schedule RushSports3", "RS3"]
        self.file_extension = ".xlsx"
        self.filename_pattern = "rs3 epg*.xlsx"
    ...
    def fetchData(self) -> dict:
        ...
        for email_id in reversed(mail_ids):
            ...
            for part in msg.walk():
                ...
                return parseRushSport3Xlsx(file_content)
