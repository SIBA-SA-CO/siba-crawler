...
class BetScraper(ScraperBase):
    """
    A scraper class for retrieving and processing the program guide for Bet.
    ...
    def scrapeProgramGuide(self, startDate: str, numberOfDays: int, charReplacements: dict) -> None:
        """
        Scrapes the program guide for Bet over a range of days starting from the given date.
